...
function qohelet_options_display_sidebar() { 
        ...
        $ocws_theme_screenshot_thumb = "goldenbowl400.png";
        $ocws_theme_op_text = "<p><strong>Golden Bowl</strong> is a child theme of Qohelet, which is a fully responsive theme for Wordpress. It has been built on the shoulders of giants, utilizing a number of other technologies, such as: 1. The Quark starter theme by Anthony Horton. 2. Quark is in turn built upon Underscores by Automattix. 3. Quark utilizes Normalize, Modernizr and Options Framework. 4. Many other smaller amounts of other technologies have been incorporated, so that I did not re-invent the wheel.</p>";
        
	 ?>
        <div id="optionsframework-sidebar">
		<div class="metabox-holder">
	    	<div class="ocws_postbox">
	    		<h3><?php esc_attr_e( 'About Golden Bowl', 'qohelet' ); ?></h3>
                        <img src="<?php echo str_replace('qohelet','golden_bowl',get_template_directory_uri()).'/assets/'.$ocws_theme_screenshot_thumb; ?>" style="margin-right:auto; margin-left:auto; width:300px;" />
